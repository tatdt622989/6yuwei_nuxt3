        ...
        <div class="main">
            <div class="wrap">
                ...
                <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                    ...
                    the
                    help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy
                        Policy
                        Generator</a>.</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot;
                            or &quot;Our&quot; in this Agreement) refers to 6yuwei.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to 6yuwei, accessible from <a href="https://6yuwei.com/"
                                rel="external nofollow noopener" target="_blank">https://6yuwei.com/</a></p>
                    </li>
                    <li>
                ...
                <p>You may also have the option of sharing additional information with the Company through Your Third-Party
                    Social
                    Media Service's account. If You choose to provide such information and Personal Data, during
                    registration or
                    otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with
                    this
                    Privacy Policy.</p>
                ...
                <ul>
                    ...
                    <li><strong>With other users:</strong> when You share personal information or otherwise interact in the
                        ...
                        outside.
                        If You interact with other users or register through a Third-Party Social Media Service, Your
                        contacts
                        on
            ...
            <ul>
                <li>By email: contact@6yuwei.com</li>
            </ul>
        </div>
    </div>
</div></template>
    ...
    meta: [
        {
            hid: "description",
            name: "description",
            content: "6yuwei Privacy Policy",
        },
    ],
});
</script>

<style lang="scss" scoped>.inner-page {
    .main {
        padding: 45px 0 90px;
        color: $secColor;
        line-height: 1.5;
