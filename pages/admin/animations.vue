            ...
            <tbody>
              <tr v-for="animation in animations" :key="animation._id">
                ...
                <td>
                  <div
                    class="preview-box"
                    @click="openEditorModal('edit', animation)"
                  >
                    <img
                ...
                <td>
                  <div class="action-wrap">
                    <button
                      class="action copy"
                      @click="openConfirmModal(copyWebsite, animation._id)"
                    >
                    ...
                    <button
                      class="action delete"
                      @click="openConfirmModal(deleteData, animation._id)"
                    >
                      <span class="material-symbols-outlined icon">
                        delete
                      </span>
...
const setEditorData = (data: Animation) => {
  editorModal.data = data as Editor;
};
